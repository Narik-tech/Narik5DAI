...
- **Transformer:** a separate experimental engine averages shallow partial-move scores to rank complete-turn candidates, promotes candidates to True Evaluations, and dynamically expands leading True ranks across depths. Every admitted candidate is eligible for deeper search within the budget. Its context and candidate limits can miss information and tactics; trained strength is unmeasured. See [the transformer guide](docs/transformer.md).

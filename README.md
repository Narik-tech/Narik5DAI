...
- **Search:** no beam cap or chess null-move assumption in normal-depth search. Quiescence is selective and finite, so horizon errors are still possible. Time budgets can expire before depth one on a large multiverse.
